...
public class BarcodeFactory {
     ...
     */
    public static String createLogoCode(String code) throws FileNotFoundException {
        String codePath = PathUtil.getUploadPath()+code+".png";
        String codeIconPath = PathUtil.getLogoPath();
    	BarcodeFactory.encode(PathUtil.REGISTER_URL,300, 300, codeIconPath, codePath,false);
    	return codePath;
    }
...
//        System.out.println(ResourceUtils.getURL("classpath:").getPath());
        createLogoCode("U10001");
//        BarcodeFactory.encode("http://apptest.ms1491.com/u12122",300, 300, codeIconPath, codePath,false);
    }
}